...
#: назвали.
#:
#: Неопределённая форма нужна наравне с личной: переход предлагают не реже,
#: чем объявляют. «Предлагаю перейти к Республике Тыва» — на записи 17.09
#: единственный доклад, который разметка потеряла, и потеряла ровно на этом.
_MOVE = (
    "переходим к", "перейдем к", "перейдём к", "перейти к",
    "вернемся к", "вернёмся к", "вернуться к",
...
_QUIET = (
    ...
    "перейти к", "вернемся к", "вернёмся к", "вернуться к",
)
