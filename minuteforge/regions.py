...
#: обычно порознь: «Следующий регион.» — и уже в следующей фразе «Гамзатбек
#: Ханифович, Кисловодск». Двух хватает; дальше начинает попадаться регион,
...
def follow(blocks: Sequence[object]) -> list[tuple[float, str]]:
    ...
    for position, (start, sentence) in enumerate(flat):
        ...
        # следующей фразой «Гамзатбек Ханифович, Кисловодск». Пока смотрели
